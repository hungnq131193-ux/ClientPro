...
[![Version](https://img.shields.io/badge/version-1.5.9-blue.svg)](manifest.json)
...
**1. Phiên bản app (semver)** — hiện tại **`1.5.9`**. Nguồn: `package.json` → `version`. Sửa ở đó rồi chạy:
...
**2. Tag cache-buster asset** — hiện tại **`PERFFIX_20260710`**. Nguồn: `ASSET_V` trong `sw.js`; phải đồng nhất với mọi query `?v=` trong `index.html` và `MAPLIBRE_V` trong `assets/03_map.js`. Đổi tay khi thay asset.
