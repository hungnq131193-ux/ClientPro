...
[![Version](https://img.shields.io/badge/version-1.0.9-blue.svg)](manifest.json)
...
- **Phiên bản app (semver)** — hiện tại **`1.0.9`**. Số kỹ thuật nội bộ giữ cho tooling đồng bộ và tương thích, không hiển thị cho người dùng. Nguồn duy nhất: `package.json`.
- **cache-buster asset** — hiện tại **`PINPAD_20260720`**. Nguồn: `ASSET_V` trong `sw.js`.
