...
- **Phiên bản app (semver)** — hiện tại **`1.0.0`**. Số kỹ thuật nội bộ giữ cho tooling đồng bộ và tương thích, không hiển thị cho người dùng. Nguồn duy nhất: `package.json`.
- **cache-buster asset** — hiện tại **`GENESIS_20260714`**. Nguồn: `ASSET_V` trong `sw.js`.
