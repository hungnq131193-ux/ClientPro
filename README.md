...
- **Phiên bản app (semver)** — hiện tại **`1.0.7`**. Số kỹ thuật nội bộ giữ cho tooling đồng bộ và tương thích, không hiển thị cho người dùng. Nguồn duy nhất: `package.json`.
- **cache-buster asset** — hiện tại **`COPYNORM_20260716`**. Nguồn: `ASSET_V` trong `sw.js`.
