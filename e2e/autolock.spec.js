...
// Ẩn < 60s -> không khóa; ẩn >= 60s (tua Date.now ở nhánh kiểm tra bù khi hiện lại)
...
test('ẩn app < 60s -> KHÔNG khóa; ẩn >= 60s -> khóa và mở lại được bằng PIN', async ({ page }) => {
  ...
  // 2) Ẩn >= 60s: tua Date.now +61s để đi vào nhánh kiểm tra bù lúc hiện lại
