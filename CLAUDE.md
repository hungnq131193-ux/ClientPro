...
| Phiên bản app (semver) | `1.0.0` | `package.json` (single source of truth — số kỹ thuật nội bộ, không hiển thị cho người dùng) |
| Cache-buster asset | `GENESIS_20260714` | `ASSET_V` trong `sw.js` |
