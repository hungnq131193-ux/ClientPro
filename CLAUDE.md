...
| Phiên bản app (semver) | `1.0.9` | `package.json` (single source of truth — số kỹ thuật nội bộ, không hiển thị cho người dùng) |
| Cache-buster asset | `PINPAD_20260720` | `ASSET_V` trong `sw.js` |
