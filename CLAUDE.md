...
| Phiên bản app (semver) | `1.0.7` | `package.json` (single source of truth — số kỹ thuật nội bộ, không hiển thị cho người dùng) |
| Cache-buster asset | `COPYNORM_20260716` | `ASSET_V` trong `sw.js` |
