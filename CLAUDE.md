...
- **Z-index tiers (v1.5.8)**: modal nghiệp vụ (add/asset/approve/camera/backup/ref-price/dup-warning) = `z-[200]`; menu = `z-[70]`; guide = `z-[80]`; map FAB = `z-[400]`; loader/toast = `z-[500]`; picker = `z-[10050]`. Không để modal dưới map FAB.
