...
| Phiên bản app (semver) | `1.0.2` | `package.json` (single source of truth — số kỹ thuật nội bộ, không hiển thị cho người dùng) |
| Cache-buster asset | `ONBOARD_20260715` | `ASSET_V` trong `sw.js` |
